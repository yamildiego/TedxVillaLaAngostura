                    ...
                    <CardGroup>
                        {
                            this.props.speakers.map(item => {
                                return (
                                    <Card key={item.id} className="pointer" style={{ margin: "10px" }} onClick={() => { this.openModal(item) }}>
                                        <Card.Img variant="top" src={item.image} />
                                        <Card.Body>
                                            <Card.Title className="text-center" style={{ fontSize: "16px" }}>{item.name}</Card.Title>
                                            <Card.Text className="TextTitle">
                                                "{item.title}"
                                            </Card.Text>
                                        </Card.Body>
                                    </Card>
