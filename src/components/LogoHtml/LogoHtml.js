  ...
  render() {
    return (
      <div className="LogoHtml" style={{ fontSize: this.props.size ? this.props.size : "3.75rem" }}>
        ...
        <span className="LogoHtmlCity" style={{ color: this.props.color ? this.props.color : "white" }}>
          VillaLaAngostura
        </span>
        <div className="LogoHtmlInfo" style={{ color: this.props.color ? this.props.color : "white" }}>
